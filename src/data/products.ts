...
export const PRODUCTS: Product[] = [
  ...
  {
    slug: "zidimi-browser",
    i18nKey: "Products.items.browser",
    icon: Globe,
    gradient: "from-[#7E22CE] to-[#3B0764]",
    accent: "text-[#EA0232]",
    rating: 4.9,
    downloads: "15.2M",
    size: "85 MB",
    ...
    requirements: {
      osKey: "ProductDetail.reqs.browser.os",
      cpuKey: "ProductDetail.reqs.browser.cpu",
      ramKey: "ProductDetail.reqs.browser.ram",
      diskKey: "ProductDetail.reqs.browser.disk",
      internetKey: "ProductDetail.reqs.browser.internet",
    },
    detailedFeatures: [
      { icon: Zap, key: "browser.df1" },
      { icon: ShieldCheck, key: "browser.df2" },
    ...
    faqs: [
      ...
      { qKey: "browser.q2", aKey: "browser.a2" },
      { qKey: "browser.q3", aKey: "browser.a3" },
      { qKey: "browser.q4", aKey: "browser.a4" },
    ],
    howItWorks: [
      { step: "01", titleKey: "browser.h1t", descKey: "browser.h1d" },
      { step: "02", titleKey: "browser.h2t", descKey: "browser.h2d" },
      { step: "03", titleKey: "browser.h3t", descKey: "browser.h3d" },
    ],
  },
  {
    slug: "zidimi-privacy",
